...
INSERT INTO `__new_user_table`("id", "name", "gender", "birthday", "exerciseLevel", "height", "age", "cutOrBulk", "currentWeight", "targetWeight", "pace") SELECT "id", "name", "gender", "birthday", "exerciseLevel", "height", "age", "cutOrBulk", "currentWeight", "targetWeight", "pace" FROM `user_table`;--> statement-breakpoint
